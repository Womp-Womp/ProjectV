...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ProjectManager_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_ProjectManager_t qt_meta_stringdata_ProjectManager = {
    {
        QT_MOC_LITERAL(0, 14)   // "ProjectManager"
    },
    "ProjectManager"
};
...
Q_CONSTINIT static const uint qt_meta_data_ProjectManager[] = {
...
Q_CONSTINIT const QMetaObject ProjectManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProjectManager.offsetsAndSizes,
    qt_meta_data_ProjectManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ProjectManager_t,
        // Q_OBJECT / Q_GADGET
